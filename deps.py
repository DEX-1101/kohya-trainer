...
subprocess.run("pip install opencv-python-headless==4.9.0.80 accelerate==0.21.0 huggingface-hub==0.20.3 transformers==4.41.0", shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
