...
subprocess.run("pip install -q flax==0.8.4 jax==0.4.23 jaxlib==0.4.23", shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
subprocess.run("pip install accelerate==0.21.0 huggingface-hub==0.26.2 transformers==4.46.2 opencv-python-headless==4.9.0.80", shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
