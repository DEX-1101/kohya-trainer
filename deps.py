...
subprocess.run("pip install flax==0.8.4 jax==0.4.23 jaxlib==0.4.23 install opencv-python-headless==4.9.0.80 sentence-transformers==3.2.0 peft==0.13.0", shell=True)
