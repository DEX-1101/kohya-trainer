...
subprocess.run("pip install -q flax==0.8.4 jax==0.4.23 jaxlib==0.4.23 opencv-python-headless numpy==1.26.4 httpx==0.28.1 protobuf==5.29.1 open-clip-torch==2.32.0 wandb==0.21.0", shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
