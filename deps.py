...
subprocess.run("pip install httpx==0.28.1 huggingface-hub==0.33.4 numpy==2.0.0 protobuf==5.29.1 open-clip-torch==2.32.0 wandb==0.21.0 diffusers==0.29.0", shell=True)
