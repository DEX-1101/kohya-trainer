...
subprocess.run("pip install httpx==0.28.1 numpy==1.26.4 protobuf==5.29.1 open-clip-torch==2.32.0 wandb==0.21.0 diffusers==0.33.1 jedi==0.19.2 huggingface-hub==0.34.4", shell=True)
